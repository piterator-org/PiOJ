...
func (app App) Handle() *http.ServeMux {
	app.ServeMux.HandleFunc("/problem/create", func(w http.ResponseWriter, r *http.Request) {
		var problem Problem
	...
	app.ServeMux.HandleFunc("/problem/get", func(w http.ResponseWriter, r *http.Request) {
